...
* The original package name 'com.ctrust.sft-be' is invalid and this project uses 'com.ctrust.sftbe' instead.
...
* [Serving Web Content with Spring MVC](https://spring.io/guides/gs/serving-web-item/)
